...
Teams - Add Team Channel
'@
Invoke-HelloIDDelegatedForm -DelegatedFormName $delegatedFormName -DynamicFormGuid $dynamicFormGuid -AccessGroups $delegatedFormAccessGroupGuids -Categories $delegatedFormCategoryGuids -UseFaIcon "True" -FaIcon "fa fa-plus-square-o" -returnObject ([Ref]$delegatedFormRef) 
<# End: Delegated Form #>
...
'@; 
	...
	$tmpVariables = @'
[{"name":"description","value":"{{form.description}}","secret":false,"typeConstraint":"string"},{"name":"displayName","value":"{{form.ChannelName}}","secret":false,"typeConstraint":"string"},{"name":"groupId","value":"{{form.teams.GroupId}}","secret":false,"typeConstraint":"string"}]
'@ 
