...
$formName = "Teams - Add Team Channel"
$formGuid = ""
try
{
    try {
...
$delegatedFormName = "Teams - Add Team Channel"
$delegatedFormGuid = ""
...
$taskActionName = "Teams-add-team-channel"
$taskActionGuid = ""
try {
...
'@;
            ...
            variables = @(@{name = "description"; value = "{{form.description}}"; typeConstraint = "string"; secret = "False"},
                        @{name = "displayName"; value = "{{form.ChannelName}}"; typeConstraint = "string"; secret = "False"},
